            ...
            <div class="card-body">
                <form method="POST" action="{{ route('distributor.update', $data->id) }}">
                    ...
                    <div class="row mb-3">
                        ...
                        <div class="col-sm-10">
                            <input type="text" class="form-control @error('alamat') is-invalid @enderror" name="alamat" value="{{ old('alamat', $data->alamat) }}" placeholder="Masukkan Nama">
                            @error('alamat')
                            <div class="alert alert-danger mt-2">
                                {{ $message }}
                            </div>
                    ...
                    <div class="row mb-3">
                        ...
                        <div class="col-sm-10">
                            <input type="text" class="form-control @error('telepon') is-invalid @enderror" name="telepon" value="{{ old('telepon', $data->telepon) }}" placeholder="Masukkan Nama">
                            @error('telepon')
                            <div class="alert alert-danger mt-2">
                                {{ $message }}
                            </div>
